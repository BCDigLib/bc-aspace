...
# https://github.com/archivesspace/archivesspace/blob/v2.8.1/frontend/app/controllers/top_containers_controller.rb

# original file version: v2.5.0
# https://github.com/archivesspace/archivesspace/blob/v2.1.0/frontend/app/controllers/top_containers_controller.rb

# Note: This file has trivial differences between itself and v2.5.0, and should be removed from the servers. Plus
#   this file is outdated from version introduced in v2.8.x.
